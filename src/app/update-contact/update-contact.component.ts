...
export class UpdateContactComponent implements OnInit {
  ...
  ngOnInit(): void {
    // get contact id from url parameter using Activated route
  this.activateRoute.params.subscribe((data:any)=>{
    console.log(data['contactId']);
    this.contactId=data['contactId']
  })  

    //  call apiforgetting particular contact details
this.api.viewContact(this.contactId).subscribe((data:any)=>{
 this.contact = data
 console.log(this.contact);
 
})
// api to get allgroups from service class
...
// update contact
updateContact(){
// apicall for updating the existing contact, arg:updated contact,contact Id
